    ...
    pageEncoding="UTF-8"%>
			<div class="tab-menu">
				<div class="row mt-3 mb-3 text-center" style="color: white;">
					<h6 class="ps-3" style="font-size: 40px;" ><i class="fa-brands fa-github"></i> <a href="index" style="text-decoration: none; color: white">CarRental</a>  </h6>
					<h6 class="ps-3" style="font-size: 20px;" > Administrator </h6>
					<hr>
				</div>
				
				<div class="row justify-content-center">
				<a href="/car/home" class="btn text-start"type="button" style="font-size: 16px; padding-left: 30px; color: white"><i class="fa-solid fa-house"></i> HOME</a>
